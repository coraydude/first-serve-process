...
(function () {
  ...
  var els = document.querySelectorAll('.svc-card,.ab-commit-row,.qa,.step,.ab-panel,.split-card,.related-card,.stat-tile,.ab-portal,.ab-map-panel,.faq details,.ab-doc,.ab-sms,.ab-timeline,.ab-daybar,.ab-locate,.ab-log,.ab-seal-card,.ab-evidence,.ab-windows,.ab-checklist,.ab-ring,.ab-bars,.ab-trail,.ab-ledger,.ab-files,.ab-next');
